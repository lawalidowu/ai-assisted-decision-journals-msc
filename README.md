...
| `data/processed/inquiry/` | Extracted transcript text (usually local only) |
...
| n=60 JEE/DQ/faithfulness audit | Chunk/overlap sensitivity (Aug 2026) |
| Clustering of n=414 | Model comparison on six excerpts (Aug 2026) |
...
- **Supplementary model runs** — Aug 2026 experiments used then-current model aliases (`gpt-5.6-terra`, etc.) that may not remain available.
...
│   └── processed/            # Extracted text (local)
